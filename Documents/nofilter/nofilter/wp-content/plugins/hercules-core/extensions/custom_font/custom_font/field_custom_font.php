...
//			print_r($def_values);
			...
			$defaults = array (
					...
					'content_title' => esc_html__('Font', 'buzzblogpro')
			);

			$this->field = wp_parse_args($this->field, $defaults);
			echo '<div class="redux-slides-accordion2" data-new-content-title="' . esc_attr(sprintf(__('Adding new %s', 'buzzblogpro'), $this->field['content_title'])) . '">';
...
">' . $preview_text . '</span>';
				...
				echo '<span class="button media_upload_font_button" id="add_' . $x . '">' . esc_html__('Upload', 'buzzblogpro') . '</span>';
				...
				echo '<span class="button remove-image' . $hide . '" id="reset_' . $x . '" rel="' . $slide['attachment_id'] . '">' . esc_html__('Remove', 'buzzblogpro') . '</span>';
				...
				echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . esc_html__('Delete', 'buzzblogpro') . '</a></li>';
				echo '</ul></div></fieldset></div>';
				$x ++;
			}
			echo '</div><a href="javascript:void(0);" class="button redux-slides-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->field['name'] . '[title][]' . $this->field['name_suffix'] . '">' . sprintf(__('Add %s', 'buzzblogpro'), $this->field['content_title']) . '</a><br/><br/>';
		}
