...
<div class="row row-eq-height">
 ...
 <?php } ?>
<?php if (buzzblogpro_getVariable('fullwidth_menu')== 'yes') {
$container = 'container-fluid fullwidthmenu';
$topcontainerfull = 'top-container-full';
}else{
$container = 'container';
$topcontainerfull = 'top-container-full top-container-nofull';
} ?>
 
<div class="top-bar <?php echo esc_attr($topcontainerfull); ?>">
<?php
...
<?php if ( is_active_sidebar( 'hs_left_fullwidthleftright_menu' )) { ?>
  <div class="top-left">
        <?php dynamic_sidebar("hs_left_fullwidthleftright_menu"); ?>
    </div>
<?php } ?>
...
<?php if ( is_active_sidebar( 'hs_right_fullwidthleftright_menu' )) { ?>
  <div class="top-right">
        <?php dynamic_sidebar("hs_right_fullwidthleftright_menu"); ?>
    </div>
<?php } ?>
<?php get_template_part( 'includes/cart' ); ?></div>
<?php if (buzzblogpro_getVariable('mainmenu_shadow_menu')== 'yes') { ?>
</div>
<?php } ?>
<?php
