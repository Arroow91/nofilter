...
<div class="post list_post_content zigazg <?php echo esc_attr($class.$secondimage); ?>">
		<div class="row row-eq-height"><div class="<?php if ($counter % 2 == 1){echo 'col-xs-12 col-sm-'.$prop1.' col-md-'.$prop1.' ';} else if ($counter % 2 == 0){echo 'col-xs-12 col-sm-'.$prop1.' col-md-'.$prop1.' col-sm-push-'.$prop2.' col-md-push-'.$prop2.'';} ?>">
		...
		<div class="left-space <?php if ($counter % 2 == 1){echo 'col-xs-12 col-sm-'.$prop2.' col-md-'.$prop2.'';} else if ($counter % 2 == 0){echo 'col-xs-12 col-sm-'.$prop2.' col-md-'.$prop2.' col-sm-pull-'.$prop1.' col-md-pull-'.$prop1.'';} ?>">
...
<?php buzzblogpro_post_meta(array('author', 'date', 'comments', 'reading_time', 'views'), false, 'meta-space-top'); ?>
