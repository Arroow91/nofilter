...
if ($heroimage) {
	 $custom_css = 'style="background-image: url('.$heroimage.');"';
	}else{$custom_css = '';} ?>
<div class="hero-featured" <?php echo $custom_css;?>></div>

<div class="spacer"></div>
<div class="container <?php echo esc_attr($content_width); ?>"><div class="row"><div class="col-md-12"><?php get_template_part('post-template/post-meta-top');  ?></div></div></div>
...
<?php } ?>
<article itemscope itemtype="http://schema.org/Article" id="post-<?php the_ID(); ?>" <?php post_class(array('post__holder','layout6')); ?>>
