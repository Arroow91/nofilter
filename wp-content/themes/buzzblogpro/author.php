...
<?php get_template_part('title'); ?>
				<div class="row">
                    <div class="col-md-<?php echo esc_attr( $main_class); ?> <?php if (buzzblogpro_getVariable('blog_sidebar_pos')==''){echo 'right';}else{echo esc_attr( buzzblogpro_getVariable('blog_sidebar_pos')); } ?>" id="content">
