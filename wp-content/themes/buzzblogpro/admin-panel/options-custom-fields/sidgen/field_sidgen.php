...
if ( ! class_exists( 'ReduxFramework_sidgen' ) ) {
    ...
    class ReduxFramework_sidgen {
        ...
        public function render() {
            ...
            $this->add_text   = ( isset( $this->field['add_text'] ) ) ? $this->field['add_text'] : esc_html__( 'Add Sidebar', 'buzzblogpro' );
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
               ...
               get_template_directory_uri().'/admin-panel/options-custom-fields/sidgen/field_sidgen.js',
