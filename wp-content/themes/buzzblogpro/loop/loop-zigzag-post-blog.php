...
<?php 
$counter = 1;
$proportions = buzzblogpro_getVariable('blog_zigzag_proportions') ? buzzblogpro_getVariable('blog_zigzag_proportions') : '70';
...
<div class="post list_post_content zigazg <?php echo esc_attr($class.$secondimage); ?>">
		<div class="row row-eq-height"><div class="<?php if ($counter % 2 == 1){echo 'col-xs-12 col-sm-12 col-md-'.$prop1.' ';} else if ($counter % 2 == 0){echo 'col-xs-12 col-sm-12 col-md-'.$prop1.' col-md-push-'.$prop2.'';} ?>">
		...
		<div class="left-space <?php if ($counter % 2 == 1){echo 'col-xs-12 col-sm-12 col-md-'.$prop2.'';} else if ($counter % 2 == 0){echo 'col-xs-12 col-sm-12 col-md-'.$prop2.' col-md-pull-'.$prop1.'';} ?>">
...
<?php
	...
	<?php 
	echo '<div class="spacer"></div><div class="spacer"></div><div class="row"><div class="col-md-12"><div class="under-first-post">';
...
<?php
	...
	<?php 
	echo '<div class="spacer"></div><div class="spacer"></div><div class="row"><div class="col-md-12"><div class="under-second-post">';
...
<?php
	...
	<?php 
	echo '<div class="spacer"></div><div class="spacer"></div><div class="row"><div class="col-md-12"><div class="under-third-post">';
...
<?php
	...
	<?php 
	echo '<div class="spacer"></div><div class="spacer"></div><div class="row"><div class="col-md-12"><div class="under-fourth-post">';
...
<?php
	...
	<?php 
	echo '<div class="spacer"></div><div class="spacer"></div><div class="row"><div class="col-md-12"><div class="under-fifth-post">';
