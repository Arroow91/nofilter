...
<div class="post list_post_content zigazg  <?php echo esc_attr($secondimage); ?>">
		<div class="row row-eq-height"><div class="<?php if ($counter % 2 == 1){echo 'col-xs-12 col-sm-6 col-md-6 ';} else if ($counter % 2 == 0){echo 'col-xs-12 col-sm-6 col-md-6 col-sm-push-6 col-md-push-6';} ?>">
			            <?php	
			            $args = array(
