...
<article id="post-<?php the_ID(); ?>" <?php post_class(array('post__holder',$posttype)); ?>>
<?php buzzblogpro_formaticons(); ?>

	<div class="row">
	<div class="col-md-12">
	<?php 
	if($enable_overlay_mode != 'yes' && !has_post_format( array('quote'))) {
...
<?php get_template_part('post-template/post-meta-top'); ?>
	...
	<?php get_template_part('post-template/link'); ?>
	<?php elseif(has_post_format( array('quote'))) : ?>
	<?php ?>
	<?php else : ?>
	...
	<?php } ?>
	<?php 
	$full_content = buzzblogpro_getVariable( 'full_content' ) ? buzzblogpro_getVariable( 'full_content' ) : 'yes';  
