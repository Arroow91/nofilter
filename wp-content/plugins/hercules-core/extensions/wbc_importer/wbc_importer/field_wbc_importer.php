            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    if ( false == $imported ) {
						...
						echo '<div id="wbc-importer-uninstall" class="wbc-importer-buttons button-primary import-demo-data importer-button importer-button-uninstall">'.esc_html__( 'Uninstall', 'framework' ).'</div>';
                    }
                    echo '</div>';
                    echo '</div>';
